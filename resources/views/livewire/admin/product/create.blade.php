                ...
                <div class="mb-3">
                    ...
                    <select name="brand" class="form-control" wire:model="selectedBrand">
                        ...
                        @foreach ($brands as $brand)
                            <option value="{{ $brand->name }}" >{{ $brand->name }} ({{$brand->category->name}})</option>
                        @endforeach
                    </select>
                </div>
                @endif
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="p-2 border">
                                Color: <input type="checkbox" name="colors[{{$data->id}}]" value="{{$data->id}}"/>{{$data->name}}
                                <br/>
                                Quantity: <input type="number" name="colorquantity[{{$data->id}}]" style="width:70px; border:1px solid"/>
                            </div>
                        </div>
                        @empty
                            <div class="col-md-12">
