<div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2"><a href="{{ url('/new-arrival') }}" class="text-white">New Arrivals Products</a>
                    </div>
    ...
    <div class="copyright-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <p class=""> &copy; 2023 - {{ $appSetting->website_name ?? 'website name' }}. All rights
                        reserved.</p>
                </div>
                <div class="col-md-4">
                    <div class="social-media">
                        ...
                        @if ($appSetting->twitter)
                            <a href="{{ $appSetting->facebook }}" target="_blank"><i class="fa fa-twitter"></i></a>
                        @endif
